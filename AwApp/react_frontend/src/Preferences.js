      ...
      <ThemeProvider theme={theme}>
        <Grid container spacing={2}>
          <Grid item xs>
            ...
            <Grid item xs>
                <Popup trigger={<form action='/grabShifts'method='post'><Button size="large" color="primary" borderColor="secondary.main" variant="outlined" fullWidth="true">2-4</Button></form>} modal={true}>
                  {close => (
                    <div>
                      <h2 id="shifttitle">Preferred Shifts</h2>
                      <p><Button startIcon={<AddCircleIcon/>}>Add Preference</Button></p>
                      <p id="shiftpopup">
                        <form action='/grabShifts'method='post'></form>
                      </p>
                    </div>
                  )}
                </Popup>
